...
export default function NavBar() {
    ...
    return (
        <nav className="flex justify-between items-center py-1  w-full md:max-w-7xl mx-auto px-3 md:px-0">
            ...
            </Link>
            {
                location.pathname === "/" ?
                    ...
                    <section className="flex items-center justify-center  w-full max-w-fit ">
                        <FormIpAddress styleForm="flex-row justify-end" styleInput="w-15 h-9" stylePoint="text-xl h-7" styleButton="px-4 py-2 text-sm" />
                    </section>
            }
        </nav>
    )

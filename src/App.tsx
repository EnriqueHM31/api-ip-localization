  ...
  return (
    <div className="w-full min-h-screen bg-linear-to-b from-slate-900 via-gray-900 to-gray-700 flex pt-10 flex-col ">
      ...
      <section className="flex flex-col items-center justify-center py-5 gap-8">
        ...
        <form className="flex items-center w-full max-w-4xl">
          <input type="text" placeholder="Buscar una IP" className="w-full px-4 py-4 rounded-bl-2xl rounded-tl-2xl bg-white text-blue-950" />
          <button type="submit" className="bg-blue-600 cursor-pointer text-white px-8 py-4 rounded-br-2xl rounded-tr-2xl font-bold">Buscar</button>
        </form>
      </section>
    </div>
  )
